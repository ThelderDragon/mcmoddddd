...
import net.mcreator.deneme.fluid.SteamFluid;
import net.mcreator.deneme.DenemeMod;

public class DenemeModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, DenemeMod.MODID);
