...
@Mod("deneme")
public class DenemeMod {
	public static final Logger LOGGER = LogManager.getLogger(DenemeMod.class);
	public static final String MODID = "deneme";
	...
	public DenemeMod() {
		...
		DenemeModMenus.REGISTRY.register(bus);
